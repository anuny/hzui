...
// 读取用户配置文件
const customConfigPath = path.resolve(DIR_APP, 'config/index.js');
...
const config = (function(){
	...
	let configs = {
		...
		resolveAlias : { 
			...
			'@' : DIR_ROOT,
			'@config' : path.resolve(DIR_APP, 'config/app.js'),
			'@components' : DIR_COMPONENTS,
			'@assets'     : DIR_ASSETS,
			'@ext'        : path.resolve(DIR_COMPONENTS, 'ext'),
			'@helper'     : path.resolve(DIR_COMPONENTS, 'helper'),
